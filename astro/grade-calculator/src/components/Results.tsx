...
export default function Results() {
  ...
  return (
    <div className="max-w-lg px-2 print-page">
      <section className="print print__landscape">
        <p>Ocjene učenika:</p>
        <table className="table-fixed border-collapse border border-slate-400 text-sm">
          <thead>
            <tr>
